const GruposModule = (() => {
    ...
    },
    {
      ...
      render: row => `
        <div class="td-actions">
          <button class="btn-icon-edit" onclick="GruposModule.openEdit(${row.id})" title="Editar">✏️</button>
          <button class="btn-icon-danger" onclick="GruposModule.remove(${row.id}, '${row.nombre}')" title="Eliminar">🗑️</button>
        </div>
      `,
    },
  ];
  ...
  function openEdit(id) {
    ...
    document.getElementById('modal-title').textContent = '✏️ Editar Grupo';
